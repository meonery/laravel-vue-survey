    ...
    <div class="py-5 px-8">
        ...
        <form @submit.prevent="submitSurvey" class="container mx-auto">
            <div class="grid grid-cols-6 items-center">
                <div class="mr-4">
                    <img :src="survey.image_url" :alt="survey.slug">
                </div>
            ...
            >
                ...
                <button
                    ...
                    type="button"
                    class="inline-flex justify-center py-2 px-4 border border-white shadow-sm text-sm font-medium rounded-md text-white bg-transparent hover:bg-white hover:text-emerald-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
