        ...
        <div class="mt-3">
            <div v-if="question.type === 'select'">
                <select 
                    ...
                    <option v-for="option of question.data.options" :value="option.text" :key="option.text">
                        {{option.text}}
                    </option>
                </select>
            </div>
            ...
            <div v-else-if="question.type === 'text'">
                    ...
                    <input 
                        ...
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm rounded-md border-gray-300"
                    />
